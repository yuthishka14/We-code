...
public class AddAddressActivity extends AppCompatActivity {
    ...
    EditText name,address,city,postalCode,phoneNumber,cardNumber;
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardNumber = findViewById(R.id.credit);
        ...
        addAddressBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String userCard = cardNumber.getText().toString();
                    ...
                    firestore.collection("CurrentUser").document(auth.getCurrentUser().getUid())
                        ...
                        public void onComplete(@NonNull Task<DocumentReference> task) {
                            ...
                            if (task.isSuccessful()){
                                Toast.makeText(AddAddressActivity.this,"Details Added",Toast.LENGTH_SHORT).show();
